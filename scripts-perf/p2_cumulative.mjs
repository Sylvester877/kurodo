// Final cumulative shots after every Phase-2 pass.
...
await sleep(9000); await evalJs('window.scrollTo(0,0)'); await sleep(1500)
await shot('p2-cumulative-home.png')
await send('Page.navigate', { url: 'http://127.0.0.1:5173/anime/5114' })
await sleep(8000)
await shot('p2-cumulative-details.png')
ws.close()
console.log('done')
