# PRIORITIES (live top-10) — refreshed 2026-09-11 post-sweep
...
5. [DONE] Schedule Miruro microcopy — 'est.' per-episode tooltip added to countdown (Schedule.tsx 2026-09-11).
...
9. [DONE] .gauntlet/recon.mjs — sticky-header regex fixed (backdrop-blur), 30/30 green (2026-09-11).
10. [DONE] Fullscreen baked-bar zoom — VideoPlayer smart-aspect + crop-detect + cover-scale audited live; manual fill/cover overrides verified (VideoPlayer.tsx 2026-09-11).
