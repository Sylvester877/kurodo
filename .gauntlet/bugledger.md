...
| 5 | SEV-4 | OPEN | fonts.googleapis.com stylesheet refused (ERR_BLOCKED_BY_CLIENT) on some loads; fonts appear to load via FontFace — confirm benign | investigate / remove dup link | — |
